...
export const RACES: readonly RaceDefinition[] = [
   {
      id: 'ciancans',
      portraitUrl: 'https://rickandmortyapi.com/api/character/avatar/372.jpeg',
   ...
   },
   {
      ...
      modifiers: { dex: 3 },
      drawbackModifiers: { cha: -1, con: -1, str: -1 },
   },
   {
      id: 'chuds',
      ...
      drawbackModifiers: { int: -1, cha: -1, dex: -1 },
   },
   {
      id: 'cromulons',
   ...
   },
   {
      ...
      modifiers: { dex: 1, int: 1, cha: 1 },
      drawbackModifiers: { str: -2, con: -1 },
   },
   {
      id: 'gearPeople',
      ...
      modifiers: { int: 2, con: 1 },
      drawbackModifiers: { str: -1, dex: -1, cha: -1 },
   },
   {
      id: 'gromflomites',
